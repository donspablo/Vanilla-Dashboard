    ...
    })), $((function ()
    {
        ...
        })), dashboard.$app.find(".connected-users").each((function (e, t)
        {
            ...
            dashboard.$app.on("dashboard.messageReceived", (function (e, t)
            {
                ...
                {
                    var i = r.indexOf(t.userId); - 1 !== i && (r.splice(i, 1), o())
                }
                return !0
            }))
...
function setup()
{
    buffer = createGraphics(windowWidth, windowHeight), buffer.colorMode(HSB), canvas = createCanvas(windowWidth, windowHeight), canvas.mouseOver(mouseOver), canvas.mouseOut(mouseOut), frameRate(60), simplex = new SimplexNoise, center = [.5 * windowWidth, .5 * windowHeight], creature = new Creature, bubbles = new Bubbles(250)
}
